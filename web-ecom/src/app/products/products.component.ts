...
@Component({
  ...
  <app-carousel></app-carousel>
    <div class="container-fluid product_container">
      <div class="row">
        <div class="col-sm-2 col-md-4 col-xlg-2" *ngFor="let product_entry of products">
  ...
  <div class="container-fluid top_collection">
     <h2 class="top__collection_header">Top Collection</h2>
      <div class="row">
        <div class="col-sm-2 col-md-4 col-xlg-2" *ngFor="let top of topCollection">
  ...
  <div class="container-fluid recommend_collection">
    <h2 class="top__collection_header">Recommended Products</h2>
      <div class="row">
        <div class="col-sm-2 col-md-4 col-xlg-2" *ngFor="let recommended of recomProduct">
    ...
    <div class="row">
      <div class="col-sm-2 col-md-4 col-xlg-2" *ngFor="let samOfficial of official">
